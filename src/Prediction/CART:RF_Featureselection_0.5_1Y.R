...
selected_features = c('result','side','avg_dpm_year_bot','avg_dpm_year_top_enemy','avg_gddiff_10_6mon_top_enemy','avg_gddiff_10_year_top_enemy','avg_kda_6mon_sup','avg_kda_year_sup',
           'avg_kda_year_sup_enemy','avg_mk_enemy_year_mid','avg_mk_enemy_year_mid_enemy','player_wr_year_sup_enemy')
