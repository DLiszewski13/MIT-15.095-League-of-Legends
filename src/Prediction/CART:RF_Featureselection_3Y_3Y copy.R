...
selected_features = c('result','avg_death_6mon_top','avg_death_6mon_top_enemy','avg_gddiff_15_year_jng','avg_gddiff_15_year_jng_enemy','avg_goldspent_year_bot','avg_goldspent_year_bot_enemy','avg_kda_6mon_sup',
           'avg_kda_6mon_sup_enemy','avg_kda_year_jng','avg_kda_year_jng_enemy','player_wr_6mon_top',
           'player_wr_6mon_top_enemy','player_wr_year_jng','player_wr_year_jng_enemy','side')
...
dc = rpart(result ~., method = 'class',data=train_selected, cp=0.01, minbucket = 5)
prp(dc,digits = 3, varlen = 0, faclen = 0, tweak = 1)
...
dc = rpart(result ~., method = 'class',data=train, cp=0.08, minbucket = 5)
prp(dc,digits = 3, varlen = 0, faclen = 0, tweak = 1)
